function tracking_table_generator_sw_mains(asset_type) {
  ...
  for (const sw_main of json_1164I_101_sewer_lines_0["features"])

  { if (sw_main.properties.type == 'MN')
   ...
   sw_main_row[1] = "<a href=\"..\\index.html#20/" + 
                     ...
                     "\" target=\"_blank\">" +
                     sw_main.properties.id_a + "</a>";
   
   sw_main_row[2] = sw_main.properties.location;
   //sw_main_row[3] = sw_main.properties.PIPE_MATRL;
   ...
   for (var bi in sw_main.properties.pp_history)
    ...
    for (bi = 1; bi < sw_main_row[6].length; bi++ )
    
      {
       ...
       while (base_sov[NN].bid_item != sw_main_row[6][bi].replace('SW-0','SW-')) { NN++; }
   ...
   sw_main_row[7] = sw_main.properties.submittals.tvi_pre_con.submittal_no;
   sw_main_row[8] = sw_main.properties.submittals.tvi_pre_con.video_no;
   ...
   sw_main_row[10] = sw_main.properties.submittals.tvi_post_con.submittal_no;
   sw_main_row[11] = sw_main.properties.submittals.tvi_post_con.video_no;
   sw_main_row[12] = sw_main.properties.submittals.tvi_post_con.response;   
